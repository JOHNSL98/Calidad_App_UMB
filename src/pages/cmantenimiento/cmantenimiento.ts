...
import { PortabilidadPage } from '../portabilidad/portabilidad';

@Component({
  selector: 'page-cmantenimiento',
  templateUrl: 'cmantenimiento.html'
})
export class CmantenimientoPage {
  ...
  public Siguiente(){
        this.navCtrl.push(PortabilidadPage,{fadec1:this.fadec1,
        fadec2:this.fadec2,
        fadec3:this.fadec3,
        fadec4:this.fadec4,
        fadec5:this.fadec5,
